...
const SearchBar = () => {
  ...
  const searchHandler = async () => {
    ...
    const res = await fetch(`https://travel-diary-backend-3x2a.onrender.com/tours/search/getTourBySearch?city=${location}&distance=${numericDistance}&maxGroupSize=${numericMaxGroupSize}`);
